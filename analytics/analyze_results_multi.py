...
def plot_experiment(experiment_paths: List[str], main_groupby = "main.env", x_axis="frames",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Plot multiple groups of experiments.')
