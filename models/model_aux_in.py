...
class ModelAuxIn(nn.Module, torch_rl.RecurrentACModel):
    def __init__(self, cfg, obs_space, action_space, use_memory=False, use_text=False, text_size=2):
        super().__init__()
        ...
        if self.use_text:
            self.text_embedding_size = text_size
            out_feat_size += text_size
