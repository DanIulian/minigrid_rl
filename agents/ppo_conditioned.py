...
class PPOConditioned(BaseAlgov2):
    ...
    def update_parameters(self):
        ...
        num_frames = self.num_frames_per_proc
        divergence_crit = torch.nn.KLDivLoss(reduction="none")
        ...
        for epoch_no in range(self.epochs):
            ...
            for inds in self._get_batches_starting_indexes():
                ...
                if self.acmodel.recurrent:
                    ...
                    memory_other = exps.memory_other[inds]
